...
/*
        ...
        try {
            ...
            for (i in 0 until filmlerListe.length()) {
                ...
                Log.e("Film Kategori id", kategori_id.toString())
                Log.e("Film Kategori ad",kategori_ad)
                Log.e("Film Yonetmen id", yonetmen_id.toString())
                Log.e("Film Yonetmen ad",yonetmen_ad)
                Log.e("****************","************")
            }
